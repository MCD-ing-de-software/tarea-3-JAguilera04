...
class TestDataCleaner(unittest.TestCase):
    ...
    def test_trim_strings_strips_whitespace_without_changing_other_columns(self):
        ...
        """
        df = make_sample_df()
        # Convertir la columna name a string dtype para que trim_strings funcione
        ...
        # Verificar que la columna "city" permanece sin cambios
    ...
    def test_remove_outliers_iqr_removes_extreme_values(self):
        ...
        """
        # Crear un DataFrame con un outlier más extremo
        df = pd.DataFrame({
            "name": ["Alice", "Bob", "Carol", "David", "Eve"],
            "age": [25, 30, 35, 40, 200],  # 200 es un outlier extremo
        ...
        self.assertNotIn(200, result["age"].values)
